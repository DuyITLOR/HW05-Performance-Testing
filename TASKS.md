...
| **Dùng AI từng bước**, không một prompt gộp (§2) | [`.claude/skills/perf-test-plan/SKILL.md`](.claude/skills/perf-test-plan/SKILL.md) — quy trình 7 bước · [`ai-audit/ai-audit-report.md`](ai-audit/ai-audit-report.md) — 8 lượt, mỗi lượt có trường *"Bước trong quy trình"* |
